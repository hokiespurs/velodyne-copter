...
[lidar,gps] = read_pcap(filename,'npoints',Total_Points);
...
%note sure why you'd want to decimate the data?? 
if Decimate_Rate~=1 && Decimate_Rate~=0 && ~isempty(Decimate_Rate)
